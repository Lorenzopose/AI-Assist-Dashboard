...
# ---------------------------
# 0. Load Environment Variables (Cloud Aware)
# ---------------------------
load_dotenv()

# This line checks local .env FIRST, then checks Streamlit Cloud Secrets SECOND
MY_API_KEY = os.getenv("GEMINI_API_KEY") or st.secrets.get("GEMINI_API_KEY")
...
if MY_API_KEY:
    ...
    st.sidebar.warning("⚠️ API Key not found. Add GEMINI_API_KEY to your .env or Streamlit Secrets.")
...
if uploaded_file:
    try:
        ...
        if uploaded_file.name.endswith(".csv"):
            ...
            # engine='openpyxl' ensures compatibility on cloud servers
        ...
        with tab2:
            ...
            if client:
                ...
                st.error("AI Client not initialized. Verify your API Key.")
